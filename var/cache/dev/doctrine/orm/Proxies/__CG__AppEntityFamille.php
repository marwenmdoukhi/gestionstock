...
class Famille extends \App\Entity\Famille implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Famille' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Famille' . "\0" . 'nomFamille', '' . "\0" . 'App\\Entity\\Famille' . "\0" . 'articles'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNomFamille(string $nomFamille): \App\Entity\Famille
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomFamille', [$nomFamille]);

        return parent::setNomFamille($nomFamille);
    }
